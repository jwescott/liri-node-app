...
function findConcert() {
  ...
  function(response) {
    ...
    for (let i = 0; i < artistData.length; i++) {
      console.log("Name of Venue: ",artistData[i].venue.name);
      console.log("Venue Location: ",artistData[i].venue.city,artistData[i].venue.region,artistData[i].venue.country);
      console.log("Date: ",moment(artistData[i].datetime,"YYYY-MM-DD").format("MM/DD/YYYY"));
